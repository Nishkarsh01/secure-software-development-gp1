...
/**
 * Uploads the given image file to storage, specifically in cover images
 * @param {*} file 
 * @returns 
 */
...
/**
 * Retrieves the given user's display name from the database
 * @param {*} userId 
 * @returns 
 */
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        let collectionTitle = formEntries.collectionTitle;
        let collectionDescription = formEntries.collectionDescription;
        ...
        const { data, error } = await db.from('collection').insert(
            [{
                user_id: user_id,
